...
/*
 ...
 Decide whether you want to compile for TOUCHkit or not
...
- (void) loadView
{
    ...
    /*
     ...
     EXAMPLE OF SETTING TOUCH PRESENTATION COLOR
     
     */
    
#if USES_TOUCHkit
    [[TOUCHkitView sharedInstance] setTouchColor:[[UIColor greenColor] colorWithAlphaComponent:0.5f]];
#endif
}
...
/*
 ...
 REPLACE YOUR PRIMARY WINDOW WITH THE WINDOW_CLASS INSTEAD OF UIWindow
 THIS ALLOWS TOUCHkit TO INTERCEPT AND FORWARD TOUCH EVENTS
 
 See: http://developer.apple.com/library/ios/#documentation/EventHandling/Conceptual/EventHandlingiPhoneOS/MultitouchEvents/MultitouchEvents.html#//apple_ref/doc/uid/TP40009541-CH3-SW17
...
{    
    ...
    window = [[WINDOW_CLASS alloc] initWithFrame:[[UIScreen mainScreen] bounds]];
